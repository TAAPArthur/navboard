...
Key defaults[] = {
    ...
    {XK_Shift_Lock, .label = "SLock", .onPress = shiftKeys,  .flags = MOD | LATCH | LOCK },
    ...
    {XK_BackSpace,  .label = "<-", .onPress = sendKeyPressWithModifiers, .onRelease = sendKeyReleaseWithModifiers},
    {-1 , .onRelease = typeKey},
    {0}
};
